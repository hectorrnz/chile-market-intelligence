...
describe('Phase 5F — scope held', () => {
  ...
  it('redesigns no page outside its own phase', () => {
    // `/portfolio` was removed from this list in Phase 5H, migrated under its
    // own brief (SegmentedControl included) — a real phase boundary moving,
    // not a relaxed assertion. It is guarded by `tests/fablePortfolioPage.test.ts`.
    for (const other of [
