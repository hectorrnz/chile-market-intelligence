...
// R13.R2 — `/portfolio` — the Summary.
// (Shipped as `/family-portfolio`; moved to the canonical route in POST-R13.5
// once the legacy positions tracker vacated it. The old URL redirects.)
//
