...
export const VALID_SOURCE_TYPES = ['manual_csv', 'cmf_fecu', 'xbrl', 'vendor_feed', 'broker_feed', 'document_ingestion', 'static_seed', 'derived', 'yahoo_finance', 'cmf_bank'] as const
