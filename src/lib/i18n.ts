  ...
  en: {
    fpAdmin: {
      ...
      refusal: {
        ...
        findings_read_failed:       'The checks recorded when this workbook was uploaded could not be read, so it cannot be reviewed or published. Nothing was written — try again.',
        console_read_failed:        'The upload, publication and import lists could not be read. Nothing shown would be complete, so nothing is shown — try again.',
        not_configured:             'The portfolio database is not reachable from this deployment.',
      },
      // ── R13.8B — the weekly workbook upload and its import plan ──────────
      uploadTitle:    'Upload a workbook',
      uploadHint:     'An .xlsx workbook. One upload may carry several unpublished weeks.',
      chooseFile:     'Choose file',
      noFileChosen:   'No file chosen',
      uploadAction:   'Upload',
      uploading:      'Uploading…',
      uploadDone:     'Uploaded. Opening the draft preview…',
      uploadKindLabel: 'Dataset',
      planTitle:      'Import plan',
      planWorkbook:   'Workbook',
      planSchema:     'Schema',
      planEndpoint:   'Current endpoint',
      planNewestFrozen: 'Newest frozen week',
      planPublication: 'New publication',
      planNew:        'New weeks',
      planGapFill:    'Gap fills',
      planChanged:    'Historical changes',
      planUnchanged:  'Unchanged',
      planInvalid:    'Not interpretable',
      planCadence:    'Cadence gaps (informational)',
      planNothing:    'Nothing to append — Production already holds every frozen week in this workbook.',
      planNoInvent:   'A calendar week the workbook never froze is never invented.',
      planGapFillHint: 'The workbook contains historical observations missing from the database. These are insertions, not overwrites — normal confirmation remains available.',
      planFrozenColumn: 'Frozen column',
      planLiveColumn: 'Live column (not published)',
      planLiveHint:   'The live =TODAY() column is Bloomberg-dependent and is never publishable. It is shown only as a diagnostic.',
      planBefore:     'before',
      planAfter:      'after',
      planCount:      'weeks',
      correctionTitle: 'Historical correction',
      correctionHint: 'This import would OVERWRITE already-published history. Review each change, then authorize it with a written reason.',
      correctionAuthorize: 'Authorize this historical correction',
      correctionReason: 'Reason for the correction',
      correctionReasonHint: 'Required. Recorded on the import operation and kept permanently.',
      importsTitle:   'Import ledger',
      colImportDate:  'As of',
      colImportCounts: 'Points',
      colImportCorrection: 'Correction',
      colImportCreated: 'Imported',
      colImportState: 'State',
      importActive:   'Active',
      importRolledBack: 'Rolled back',
      rollbackImport: 'Roll back import',
      emptyImports:   'No imports yet.',
      // ── R13.8C — owner preview: hierarchy, catch-up, correction, rollback ──
      steps: {
        label:   'Weekly update',
        choose:  'Choose workbook',
        upload:  'Upload',
        parse:   'Parse',
        preview: 'Preview',
        confirm: 'Confirm',
      },
      parsing:        'Parsing the workbook…',
      verdictNothingTitle: 'Nothing to apply',
      verdictNothingBody:  'The workbook is already reflected in the portfolio history. No changes will be made.',
      verdictAppendOneTitle:  '1 new week will be stored',
      verdictAppendManyTitle: '{n} new weeks will be stored',
      verdictAppendBody:      '{date} becomes the current publication.',
      verdictAppendManyBody:  'All {n} weeks are added to the history; {date} becomes the current publication.',
      verdictEndpointUnchanged: 'The current publication ({date}) is unchanged.',
      verdictGapFillOne:      '1 gap fill is inserted below the current endpoint.',
      verdictGapFillMany:     '{g} gap fills are inserted below the current endpoint.',
      verdictCorrectionTitle: 'Historical correction required',
      verdictCorrectionOnlyBody:  '{c} published value(s) would be overwritten. Nothing is added. Confirm only with a written reason.',
      ...
      performanceHistoryTitle:   'Weekly performance history',
      performanceHistoryNote:    'The source’s own weekly net flow, result and return at every frozen reporting date, including the many that carry no publication. This is what lets a custom period separate money earned from money moved. Analytical history, never a publication.',
      performanceHistoryInserted: '{r} metric(s) recorded across {n} reporting date(s). Recording a metric the book has never held is an insertion and needs no authorization.',
      performanceHistoryChanged:  '{r} metric(s) overwritten across {n} reporting date(s).',
      performanceHistoryChangedNote: 'A settled weekly flow, result or return is being restated. This requires authorization and a written reason, and it changes how every period spanning that week separates result from flows.',
      ...
      planLiveNotUsed:  'Not used for publication',
      planBecomesCurrent: 'becomes current',
      planAlreadyCurrent: 'already current',
      planNewHint:    'Every week listed is stored. The newest becomes the current publication.',
      colScope:       'Scope',
      colObservationDate: 'Date',
      colMetric:      'Metric',
      colCurrentValue: 'Current value',
      colWorkbookValue: 'Workbook value',
      colDelta:       'Change',
      applyCorrection: 'Apply historical correction',
      normalConfirmDisabled: 'Normal confirmation is disabled for this import — authorize the correction above.',
      nothingToApply: 'Nothing to apply',
      warningsTitle:  'Warnings',
      detailsTitle:   'Workbook review details',
      planUnavailable: 'No import plan — the workbook could not be read at a frozen week.',
      colImportSource: 'Source workbook',
      rollbackImportConfirm: 'Reverse this whole import?',
      rollbackImportHint: 'Removes every week it inserted, restores every value it corrected, and makes the previous publication current again.',
      rollbackPublicationConfirm: 'Make this revision current again?',
      importApplied:  'Import applied.',
      fixtureBadge:   'Review fixture',
      ...
      refusalImport: {
        ...
        publication_ledger_read_failed: 'The list of published weeks could not be read, so this workbook could not be placed against the book. Nothing was written — try again.',
        ...
        duplicate_workbook_observation: 'The workbook states the same identity twice.',
        plan_stale:                     'Production changed while this plan was on screen. Re-open the preview and check it again before confirming.',
        publication_date_not_newest_frozen: 'A publication must carry the newest valid frozen week.',
        no_publishable_frozen_column:   'No frozen historical week parsed cleanly. The live column is never publishable.',
        not_a_portfolio_workbook:       'The workbook has no RESUMEN structure to read a frozen week from.',
        import_refused_historical_correction_required: 'The database refused: an overwrite needs authorization and a reason.',
        import_refused_unavailable_not_representable: 'A week reported as unavailable cannot be stored in the evolution series.',
        import_refused_stale_plan_identity_exists: 'Production changed while this plan was on screen. Re-open the preview.',
        import_refused_stale_plan_identity_absent: 'Production changed while this plan was on screen. Re-open the preview.',
        import_refused_stale_plan_value_moved: 'A value this plan intended to overwrite has since moved. Re-open the preview.',
        rollback_refused_already_rolled_back: 'This import has already been rolled back.',
        rollback_refused_superseded_by_later_import: 'A later import has already rewritten one of these rows. Roll that import back first.',
        rollback_refused_publication_not_current: 'The publication this import made current is no longer current.',
        rollback_refused_import_not_found: 'That import operation was not found.',
      },
    },
    ...
    fp: {
      ...
      weeklyChanges: {
        ...
        // week would misstate the interval every figure describes.
        periodReconTitle:   'Flow and investment-result reconciliation',
        periodFromLabel:    'From Portfolio Value',
        periodToLabel:      'To Portfolio Value',
        periodProfit:       'Period P&L',
        periodFlow:         'Period Net Flows',
        periodReturn:       'Period Return',
        periodReconNote:    'From Portfolio Value + Period P&L + Period Net Flows = To Portfolio Value. Net flows are the sum of the source’s own weekly flows over the period; the P&L follows from that identity.',
        periodCrossCheck:   'Cross-checked against the sum of the source’s own weekly results over the same period.',
        periodCrossMismatch: 'The period result derived from the two portfolio values does not match the sum of the source’s own weekly results — both are shown as reported and neither has been adjusted.',
        periodFlowsUnavailable: 'Period net flows are unavailable: the source did not state a weekly flow for every reporting interval in this range, and a partial sum would understate the money moved.',
    ...
    usersAccess: {
      ...
      inviteDescription: 'The account is created with exactly the access chosen below, and an activation link is issued.',
      // D0B1 — how the invitation reaches the person it is for.
      deliveryHeading: 'Invitation delivery',
      deliveryManual: 'Create link to share manually',
      deliveryEmail: 'Send by email',
      deliveryManualNote: 'You will receive a one-time link to pass on yourself. It is shown once and cannot be retrieved afterwards.',
      deliveryEmailNote: 'The activation link is emailed to the address above. Email delivery is not configured for every domain yet.',
      createInvite: 'Create invitation',
      creatingInvite: 'Creating…',
      inviteCreated: 'Invitation created',
      manualLinkBody: 'Share this one-time link securely with',
      manualLinkLabel: 'Invitation link',
      copyInviteLink: 'Copy invitation link',
      inviteLinkCopied: 'Link copied.',
      inviteLinkCopyManually: 'The link is selected — copy it with Ctrl-C.',
      manualLinkSecurityNote: 'Anyone with this link may activate this account before the invitation expires. The link will not be shown again after you close this dialog — if it is lost, create a new invitation link instead.',
      switchToManualLink: 'Create link to share manually',
      newInviteLink: 'New invitation link',
      ...
      errInvalidDelivery: 'That delivery option is not recognised — nothing was changed.',
    ...
    auth: {
      ...
      errInviteLinkInvalid: 'This invitation link is no longer valid. It may have expired, already been used, or been replaced by a newer one. Ask an administrator to send you a new invitation.',
  ...
  es: {
    fpAdmin: {
      ...
      refusal: {
        ...
        findings_read_failed:       'No se pudieron leer las verificaciones registradas al cargar este libro, por lo que no puede revisarse ni publicarse. No se escribió nada — inténtelo de nuevo.',
        console_read_failed:        'No se pudieron leer las listas de cargas, publicaciones e importaciones. Nada de lo que se mostrara estaría completo, así que no se muestra nada — inténtelo de nuevo.',
        not_configured:             'La base de datos del portafolio no es accesible desde este despliegue.',
      },
      // ── R13.8B — la carga del libro semanal y su plan de importación ──────
      uploadTitle:    'Cargar un libro',
      uploadHint:     'Un libro .xlsx. Una carga puede contener varias semanas sin publicar.',
      chooseFile:     'Elegir archivo',
      noFileChosen:   'Ningún archivo elegido',
      uploadAction:   'Cargar',
      uploading:      'Cargando…',
      uploadDone:     'Cargado. Abriendo la vista previa…',
      uploadKindLabel: 'Conjunto de datos',
      planTitle:      'Plan de importación',
      planWorkbook:   'Libro',
      planSchema:     'Esquema',
      planEndpoint:   'Extremo actual',
      planNewestFrozen: 'Semana congelada más reciente',
      planPublication: 'Nueva publicación',
      planNew:        'Semanas nuevas',
      planGapFill:    'Rellenos de vacío',
      planChanged:    'Cambios históricos',
      planUnchanged:  'Sin cambios',
      planInvalid:    'No interpretable',
      planCadence:    'Vacíos de cadencia (informativo)',
      planNothing:    'Nada que agregar — Producción ya contiene todas las semanas congeladas de este libro.',
      planNoInvent:   'Una semana calendario que el libro nunca congeló jamás se inventa.',
      planGapFillHint: 'El libro contiene observaciones históricas que faltan en la base de datos. Son inserciones, no sobrescrituras — la confirmación normal sigue disponible.',
      planFrozenColumn: 'Columna congelada',
      planLiveColumn: 'Columna en vivo (no se publica)',
      planLiveHint:   'La columna en vivo =TODAY() depende de Bloomberg y nunca es publicable. Se muestra solo como diagnóstico.',
      planBefore:     'antes',
      planAfter:      'después',
      planCount:      'semanas',
      correctionTitle: 'Corrección histórica',
      correctionHint: 'Esta importación SOBRESCRIBIRÍA historia ya publicada. Revise cada cambio y autorícelo con un motivo escrito.',
      correctionAuthorize: 'Autorizar esta corrección histórica',
      correctionReason: 'Motivo de la corrección',
      correctionReasonHint: 'Obligatorio. Queda registrado en la operación de importación de forma permanente.',
      importsTitle:   'Registro de importaciones',
      colImportDate:  'Al',
      colImportCounts: 'Puntos',
      colImportCorrection: 'Corrección',
      colImportCreated: 'Importado',
      colImportState: 'Estado',
      importActive:   'Activa',
      importRolledBack: 'Revertida',
      rollbackImport: 'Revertir importación',
      emptyImports:   'Aún no hay importaciones.',
      // ── R13.8C — vista previa para el propietario: jerarquía, puesta al día, corrección, reversión ──
      steps: {
      ...
      parsing:        'Procesando el libro…',
      verdictNothingTitle: 'Nada que aplicar',
      verdictNothingBody:  'El libro ya está reflejado en la historia del portafolio. No se hará ningún cambio.',
      verdictAppendOneTitle:  'Se almacenará 1 semana nueva',
      verdictAppendManyTitle: 'Se almacenarán {n} semanas nuevas',
      verdictAppendBody:      '{date} pasa a ser la publicación vigente.',
      verdictAppendManyBody:  'Las {n} semanas se agregan a la historia; {date} pasa a ser la publicación vigente.',
      verdictEndpointUnchanged: 'La publicación vigente ({date}) no cambia.',
      verdictGapFillOne:      'Se inserta 1 relleno de vacío bajo el extremo actual.',
      verdictGapFillMany:     'Se insertan {g} rellenos de vacío bajo el extremo actual.',
      verdictCorrectionTitle: 'Se requiere corrección histórica',
      verdictCorrectionOnlyBody:  'Se sobrescribirían {c} valor(es) publicado(s). No se agrega nada. Confirme solo con un motivo escrito.',
      ...
      performanceHistoryTitle:   'Historial de desempeño semanal',
      performanceHistoryNote:    'El flujo neto, resultado y retorno semanales de la propia fuente en cada fecha de reporte congelada, incluidas las muchas que no tienen publicación. Es lo que permite a un período personalizado separar el dinero ganado del dinero movido. Historial analítico, nunca una publicación.',
      performanceHistoryInserted: '{r} métrica(s) registrada(s) en {n} fecha(s) de reporte. Registrar una métrica que el libro nunca ha tenido es una inserción y no requiere autorización.',
      performanceHistoryChanged:  '{r} métrica(s) sobrescrita(s) en {n} fecha(s) de reporte.',
      performanceHistoryChangedNote: 'Se está reformulando un flujo, resultado o retorno semanal ya asentado. Requiere autorización y una razón escrita, y cambia cómo todo período que abarque esa semana separa resultado de flujos.',
      ...
      planLiveNotUsed:  'No se usa para publicar',
      planBecomesCurrent: 'pasa a vigente',
      planAlreadyCurrent: 'ya vigente',
      planNewHint:    'Todas las semanas listadas se almacenan. La más reciente pasa a ser la publicación vigente.',
      colScope:       'Ámbito',
      colObservationDate: 'Fecha',
      colMetric:      'Métrica',
      colCurrentValue: 'Valor actual',
      colWorkbookValue: 'Valor del libro',
      colDelta:       'Cambio',
      applyCorrection: 'Aplicar corrección histórica',
      normalConfirmDisabled: 'La confirmación normal está deshabilitada para esta importación — autorice la corrección más arriba.',
      nothingToApply: 'Nada que aplicar',
      warningsTitle:  'Advertencias',
      detailsTitle:   'Detalles de revisión del libro',
      planUnavailable: 'Sin plan de importación — el libro no pudo leerse en una semana congelada.',
      colImportSource: 'Libro de origen',
      rollbackImportConfirm: '¿Revertir esta importación completa?',
      rollbackImportHint: 'Elimina todas las semanas que insertó, restaura todos los valores que corrigió y vuelve a dejar vigente la publicación anterior.',
      rollbackPublicationConfirm: '¿Volver a dejar vigente esta revisión?',
      importApplied:  'Importación aplicada.',
      fixtureBadge:   'Estado de revisión',
      ...
      refusalImport: {
        ...
        publication_ledger_read_failed: 'No se pudo leer la lista de semanas publicadas, por lo que este libro no pudo ubicarse dentro del historial. No se escribió nada — inténtelo de nuevo.',
        ...
        duplicate_workbook_observation: 'El libro declara la misma identidad dos veces.',
        plan_stale:                     'Producción cambió mientras este plan estaba en pantalla. Vuelva a abrir la vista previa y revísela antes de confirmar.',
        publication_date_not_newest_frozen: 'Una publicación debe llevar la semana congelada válida más reciente.',
        no_publishable_frozen_column:   'Ninguna semana histórica congelada se procesó limpiamente. La columna en vivo nunca es publicable.',
        not_a_portfolio_workbook:       'El libro no tiene una estructura RESUMEN de la cual leer una semana congelada.',
        import_refused_historical_correction_required: 'La base de datos rechazó: una sobrescritura necesita autorización y motivo.',
        import_refused_unavailable_not_representable: 'Una semana informada como no disponible no puede almacenarse en la serie de evolución.',
        import_refused_stale_plan_identity_exists: 'Producción cambió mientras este plan estaba en pantalla. Vuelva a abrir la vista previa.',
        import_refused_stale_plan_identity_absent: 'Producción cambió mientras este plan estaba en pantalla. Vuelva a abrir la vista previa.',
        import_refused_stale_plan_value_moved: 'Un valor que este plan pretendía sobrescribir ya cambió. Vuelva a abrir la vista previa.',
        rollback_refused_already_rolled_back: 'Esta importación ya fue revertida.',
        rollback_refused_superseded_by_later_import: 'Una importación posterior ya reescribió una de estas filas. Revierta esa importación primero.',
        rollback_refused_publication_not_current: 'La publicación que esta importación dejó vigente ya no lo está.',
        rollback_refused_import_not_found: 'No se encontró esa operación de importación.',
      },
    },
    ...
    fp: {
      ...
      weeklyChanges: {
        ...
        periodToLabel:      'Valor del Portafolio Hasta',
        periodProfit:       'P&L del Período',
        periodFlow:         'Flujos Netos del Período',
        periodReturn:       'Retorno del Período',
        periodReconNote:    'Valor del Portafolio Desde + P&L del Período + Flujos Netos del Período = Valor del Portafolio Hasta. Los flujos netos son la suma de los flujos semanales de la propia fuente durante el período; el P&L se deriva de esa identidad.',
        periodCrossCheck:   'Contrastado con la suma de los resultados semanales de la propia fuente en el mismo período.',
        periodCrossMismatch: 'El resultado del período derivado de los dos valores del portafolio no coincide con la suma de los resultados semanales de la propia fuente — ambos se muestran como fueron reportados y ninguno ha sido ajustado.',
        periodFlowsUnavailable: 'Los flujos netos del período no están disponibles: la fuente no declaró un flujo semanal para cada intervalo de reporte de este rango, y una suma parcial subestimaría el dinero movido.',
    ...
    usersAccess: {
      ...
      inviteDescription: 'La cuenta se crea con exactamente el acceso elegido abajo, y se emite un enlace de activación.',
      // D0B1 — cómo llega la invitación a la persona a la que va dirigida.
      deliveryHeading: 'Entrega de la invitación',
      deliveryManual: 'Crear enlace para compartir manualmente',
      deliveryEmail: 'Enviar por correo',
      deliveryManualNote: 'Recibirás un enlace de un solo uso para entregarlo tú mismo. Se muestra una sola vez y después no puede recuperarse.',
      deliveryEmailNote: 'El enlace de activación se envía por correo a la dirección de arriba. El envío de correo aún no está configurado para todos los dominios.',
      createInvite: 'Crear invitación',
      creatingInvite: 'Creando…',
      inviteCreated: 'Invitación creada',
      manualLinkBody: 'Comparte este enlace de un solo uso de forma segura con',
      manualLinkLabel: 'Enlace de invitación',
      copyInviteLink: 'Copiar enlace de invitación',
      inviteLinkCopied: 'Enlace copiado.',
      inviteLinkCopyManually: 'El enlace está seleccionado — cópialo con Ctrl-C.',
      manualLinkSecurityNote: 'Cualquier persona con este enlace puede activar esta cuenta antes de que la invitación expire. El enlace no volverá a mostrarse después de cerrar este diálogo — si se pierde, crea un nuevo enlace de invitación.',
      switchToManualLink: 'Crear enlace para compartir manualmente',
      newInviteLink: 'Nuevo enlace de invitación',
      ...
      errInvalidDelivery: 'Esa opción de entrega no se reconoce — no se hizo ningún cambio.',
    ...
    auth: {
      ...
      errInviteLinkInvalid: 'Este enlace de invitación ya no es válido. Puede haber expirado, haber sido usado, o haber sido reemplazado por uno más reciente. Solicita a un administrador que te envíe una nueva invitación.',
