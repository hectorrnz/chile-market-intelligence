...
export const dict = {
  en: {
    fpAdmin: {
      ...
      planSchema:     'Schema',
      planEndpoint:   'Production ends',
      planNewestFrozen: 'Newest frozen week',
      planPublication: 'Will become current',
      planNew:        'New dates',
      ...
      planGapFillHint: 'An insertion below the current endpoint. Nothing is overwritten, so no correction reason is required.',
  ...
  es: {
    fpAdmin: {
      ...
      planWorkbook:   'Libro',
      planSchema:     'Esquema',
      planEndpoint:   'Producción termina en',
      planNewestFrozen: 'Semana congelada más reciente',
      planPublication: 'Pasará a ser la vigente',
      planNew:        'Fechas nuevas',
      ...
      planGapFillHint: 'Una inserción bajo el extremo actual. No se sobrescribe nada, por lo que no se requiere motivo de corrección.',
