        ...
        <MacroDataProvider>
          <MobileNavProvider>
            <div className="flex flex-col h-full overflow-hidden bg-background print:block print:h-auto print:overflow-visible">
              <TopBar />
              <SecondaryNav />
              <main className="flex-1 overflow-y-auto px-3 py-4 sm:px-6 sm:py-5 bg-background print:overflow-visible print:px-0 print:py-0 w-full max-w-(--content-max-w) mx-auto">
                {children}
              </main>
              <MobileNavDrawer />
            </div>
